 ...
 * 使用单位
 */
public class ProductUnitActivity extends BaseActivity implements DicUtil.OnChoiceListener{
    private Button mBtnSearch;
    private TextView mEquipmentType, mDivisions;
    private ClearEditText mCreditCode, mPermitsProjects, mEntName, mManage, mUnitAddress;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btn_search:
                if (validate()) {
                    getParams();
                    Intent intent = new Intent(ProductUnitActivity.this, ProductUnitListActivity.class);
