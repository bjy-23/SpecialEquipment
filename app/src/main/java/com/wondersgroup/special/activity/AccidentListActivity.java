...
import com.wondersgroup.special.adapter.AccidentAdapter;
 ...
 * 事故档案列表
 */
public class AccidentListActivity extends BaseRecyclerActivity {
    ...
    protected void initView() {
        ...
        mRecyclerList.setOnItemClickListener(new BaseRecyclerView.OnItemClickListener() {
            ...
            public void onItemClick(RecyclerView parent, View view, int position, long id) {
                ...
                bundle.putString(Params.TYPE, ArchiveConstant.ACCIDENT);
                intent.putExtras(bundle);
                intent.setClass(AccidentListActivity.this, ArchiveDetailActivity.class);
    ...
    protected void getData() {
        ...
        OkHttpUtils.get()
                .url(url)
                .params(params)
                .build().execute(new ResponseCallBack<QueryAccidentResult>() {
            @Override
            ...
            @Override
            public void onResponse(QueryAccidentResult t) {
                super.onResponse(t);
                if (null != t) {
                    ...
                    if (pageNo == 1) {
                        ...
                        adapter = new AccidentAdapter(AccidentListActivity.this, t.getResultList());
